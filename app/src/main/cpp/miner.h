...
int scanhash_verus_count(int thr_id, struct work *work, uint32_t start_nonce, uint32_t max_nonce, unsigned long *hashes_done);
...
bool generate_submit_work(struct work* work);
